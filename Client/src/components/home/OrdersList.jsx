...
const OrdersList = ({key,order}) => {
  return (
    <div key={key} className=' flex items-center gap-5 mb-3'>
        <button className='bg-[#f6b100] p-3 text-xl font-bold rounded-lg'>{getIntials(order.customerDetails.name)}</button>
        <div className='flex items-center justify-between w-[100%]'>
            ...
            <div>
                <h1 className=' text-[#f6b100] font-semibold border border-[#f6b100] rounded-lg p-1 '>Table <FaLongArrowAltRight className='text-[#ababab] ml-2 inline' /> {order.table.tableNo}</h1>
            </div>
